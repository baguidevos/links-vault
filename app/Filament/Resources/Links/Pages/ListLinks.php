        ...
        return [
            ...
            ActionGroup::make([
                Action::make('scan_health')
                    ->label(__('Scanner la santé des liens'))
                ...
                Action::make('import_bookmarks')
                    ...
                    ->action(function (array $data, BookmarksImportService $importer) {
                        ...
                        Notification::make()
                            ->title(__('Importation terminée avec succès'))
                            ->body("{$stats['links_created']} liens créés, {$stats['folders_created']} dossiers, {$stats['tags_created']} tags.")
                            ->success()
                            ->send();
                    }),

                Action::make('export_html')
                    ->label(__('Exporter en HTML (Chrome / Navigateurs)'))
                ...
                Action::make('export_json')
                    ->label(__('Exporter en JSON (Sauvegarde)'))
                ...
                Action::make('export_csv')
                    ->label(__('Exporter en CSV (Excel)'))
